...
namespace Gestion_Usuarios.Controllers
{
    ...
    public class Nuevo_ingresoController : Controller
    {
        ...
        // Change this to the correct option your SP expects for nuevo ingreso if different.
        private const string OptionGetView = "getview_student_full";

        public Nuevo_ingresoController(ContextDb context)
        {
            _context = context;
        }
